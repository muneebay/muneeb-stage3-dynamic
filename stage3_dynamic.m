...
for kk=pp:1:pp+180 %defining the entries of the matrix
    k__(kk,1)= 13.7-0.1*i+(kk-(jj-1)*180-1)*0.01; %keep obstacle constant in x-axis
k__(kk,2)=13.7+0.01*(jj-1);%changing value of obstacle in y-axis
